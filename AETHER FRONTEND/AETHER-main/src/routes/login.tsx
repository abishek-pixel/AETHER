  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-hero px-4">
      <div className="w-full max-w-sm glass rounded-2xl p-8 shadow-elevated">
        ...
        <p className="text-sm text-muted-foreground text-center mb-6">Sign in to your Aether account</p>
        ...
        <p className="mt-4 text-center text-sm text-muted-foreground">
          ...
          <Link to="/signup" className="text-primary-glow underline hover:no-underline">Sign up</Link>
        </p>
      </div>
    </div>
  );
